...
Item {
    ...
    width: textInput.width + 70
    height: textInput.height + 18
    ...
    Rectangle {
        anchors.fill: container; border.color: "steelblue"; border.width: 4; color: "transparent"
        visible: textInput.focus; antialiasing: true
    }
    ...
    MouseArea {
        ...
        onClicked: {
            textInput.forceActiveFocus(); Qt.inputMethod.show()
            textInput.selectAll()
        }
    }
    //Component.onCompleted: textInput.selectAll()
}
